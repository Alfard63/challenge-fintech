...
const passwordInput = document.querySelector("#pwd-group")
let id = null;
let users = [];
...
const clearForm = () => {
  ...
  passwordInput.children[1].ariaRequired = true;
};
...
const viewUser = (id, edit) => {
  ...
  passwordInput.children[1].ariaRequired = false;
  ...
  edit === true 
    ...
    : (selects[0].disabled = true, createBtn.classL, formModal.querySelector("h2").innerHTML = '<i class="bi bi-person-fill"></i> Visualiser l\'utilisateur');
};
